...
# Script
## StevenBlack
{ echo -e "\e[30;48;5;248m⮞⮞ Downloading StevenBlack Blocklist ⮜⮜\e[0m"; } 2> /dev/null
...
{ echo -e "\e[30;48;5;248m⮞⮞ Creating Unbound Blocklist ⮜⮜\e[0m"; } 2> /dev/null
...
{ echo -e "\e[30;48;5;248m⮞⮞ Reloading Unbound Config ⮜⮜\e[0m"; } 2> /dev/null
set -x
